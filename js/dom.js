...
function updateIcons() {
  ...
  if (data1Element && iconStatus1) {
    ...
    if (data1 === 0) {
      iconStatus1.classList.remove('fa-check-circle', 'fa-warning');
      iconStatus1.classList.add('fa-times-circle');
      iconStatus1.style.color = 'red'; // Warna merah untuk times-circle
    } else if (data1 >= 20 && data1 <= 40) {
      iconStatus1.classList.remove('fa-warning', 'fa-times-circle');
      iconStatus1.classList.add('fa-check-circle');
      iconStatus1.style.color = '#6cbe77'; // Warna hijau untuk check-circle
    } else {
      iconStatus1.classList.remove('fa-check-circle', 'fa-times-circle');
  ...
  if (data2Element && iconStatus2) {
    ...
    if (data2 === 0) {
      iconStatus2.classList.remove('fa-check-circle', 'fa-warning');
      iconStatus2.classList.add('fa-times-circle');
      iconStatus2.style.color = 'red'; // Warna merah untuk times-circle
    } else if (data2 >= 50 && data2 <= 80) {
      iconStatus2.classList.remove('fa-warning', 'fa-times-circle');
      iconStatus2.classList.add('fa-check-circle');
      iconStatus2.style.color = '#6cbe77'; // Warna hijau untuk check-circle
    } else {
      iconStatus2.classList.remove('fa-check-circle', 'fa-times-circle');
  ...
  if (data3Element && iconStatus3) {
    ...
    if (data3 === 0) {
      iconStatus3.classList.remove('fa-check-circle', 'fa-warning');
      iconStatus3.classList.add('fa-times-circle');
      iconStatus3.style.color = 'red'; // Warna merah untuk times-circle
    } else if (data3 >= 50 && data3 <= 80) {
      iconStatus3.classList.remove('fa-warning', 'fa-times-circle');
      iconStatus3.classList.add('fa-check-circle');
      iconStatus3.style.color = '#6cbe77'; // Warna hijau untuk check-circle
    } else {
      iconStatus3.classList.remove('fa-check-circle', 'fa-times-circle');
